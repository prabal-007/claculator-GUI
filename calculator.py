...
root.geometry('250x505')
root.maxsize(250,505)
...
def keys():
    ...
    b1 = Button(frm1, text='c', font='lucida 25 bold')
    b1.pack(side=RIGHT, padx='3', pady='3')
    b1.bind('<Button-1>', click)

    b2=Button(frm1, text='Er', font='lucida 25 bold')
    b2.pack(side=RIGHT, padx='3', pady='3')
    b2.bind('<Button-1>', click)

    b3=Button(frm1, text='%', font='lucida 25 bold')
    b3.pack(side=RIGHT, padx='3', pady='3')
    b3.bind('<Button-1>', click)

    b4=Button(frm1, text='/', font='lucida 25 bold')
    ...
    b4=Button(frm1, text='X', font='lucida 26 bold')
    b4.pack(side=RIGHT, padx='3', pady='3')
    b4.bind('<Button-1>', click)
    frm1.pack()
    ...
    b4.pack(side=RIGHT, padx='5', pady='3')
    b4.bind('<Button-1>', click)
    frm1.pack()
    ...
    b4=Button(frm1, text='+', font='lucida 30 bold', padx='2')
    b4.pack(side=RIGHT, padx='3', pady='3')
    b4.bind('<Button-1>', click)
    frm1.pack()

    frm1 = Frame(root, bg='grey')
    b1 = Button(frm1, text='Q', font='lucida 25 bold', command=quit)
    b1.pack(side=RIGHT, padx='3')
